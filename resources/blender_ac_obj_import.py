...
bl_info = {
    "name": "Import AC OBJ files",
    "author": "poor, JuhaW, Alexander Belyakov, gentlegiantJGC",
    "version": (0, 3, 0),
    "blender": (2, 80, 0),
    "location": "File > Import-Export",
    "description": "Import multiple ACExplorer OBJ files, UV's, materials. Sets up shader to fix normal.",
    "warning": "",
    "wiki_url": "",
    "tracker_url": "",
