...
class Reader(BaseReader):
	...
	def __init__(self, py_ubi_forge, file_object_data_wrapper: FileObjectDataWrapper, out_file, indent_count):
		...
		file_object_data_wrapper.read_str(40, out_file)  # contains a compiled mesh instance 4368101B
		...
		# file_object_data_wrapper.read_str(8, out_file) # two counts. first count for transformation matrix. second for more things?
