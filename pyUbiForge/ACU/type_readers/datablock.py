...
class Reader(BaseReader):
	...
	def __init__(self, py_ubi_forge, file_object_data_wrapper: FileObjectDataWrapper, out_file, indent_count):
		...
		for _ in range(count1):
			file_object_data_wrapper.read_str(2, out_file, indent_count+1)
		...
		file_object_data_wrapper.read_str(4, out_file, indent_count)  # this might be part of the previous as a 64 bit uint
